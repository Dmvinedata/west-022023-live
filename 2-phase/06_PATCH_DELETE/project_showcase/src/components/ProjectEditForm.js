...
const ProjectEditForm = ({ projectId, completeEditing, onUpdatedProject }) => {
	const initialState = {
		id: null,
		name: "",
		about: "",
	...
	function handleSubmit(e) {
		...
		fetch("http://localhost:4000/projects/" + projectId, patchReqObj)
			.then((res) => res.json())
			.then((updatedProject) => {
				console.log(updatedProject)
				// Pessimistically update our state in APP
